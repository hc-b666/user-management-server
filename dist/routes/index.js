...
router.get("/dashboard/getUsers", auth_middleware_1.authMiddleware, dashboardController.getUsers);
router.put("/dashboard/blockUsers", auth_middleware_1.authMiddleware, dashboardController.blockUsers);
